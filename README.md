...
Solar Flare Intensity Prediction is a machine learning project that predicts the intensity of solar flare events using historical space weather data collected from NASA's DONKI (Database of Notifications, Knowledge, Information) API. The dataset contains records of solar flares, coronal mass ejections (CMEs), geomagnetic storms, and high-speed solar wind streams from the past two years.
